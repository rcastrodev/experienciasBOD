...
<!DOCTYPE html>
<html class="<?php if (wpappninja_iosstyle()) {echo 'ios with-statusbar';}else{echo 'md';} ?>" <?php if (wpappninja_is_pwa() && wpappninja_isIOS()) {echo ' manifest="' . WPAPPNINJA_ASSETS_3RD_URL . 'manifestcache.php" ';};?>>
<head>
